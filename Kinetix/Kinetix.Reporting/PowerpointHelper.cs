...
namespace Kinetix.Reporting {
    ...
    public static class PowerpointHelper {
        ...
        public static PresentationDocument CreatePresentationWithOneEmptySlide(string fileName, int slideWidth = 9144000, int slideHeight = 6858000) {
            ...
            if (slideWidth < 914440) {
                throw new ArgumentOutOfRangeException("slideWidth", slideWidth, "slideWidth should be greater than 914440.");
            }

            if (slideHeight < 914440) {
                throw new ArgumentOutOfRangeException("slideHeight", slideHeight, "slideHeight should be greater than 914440.");
            }
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreatePresentationWithOneEmptySlide.");
            }
        ...
        public static ShapeTree GetShapeTreeOfFirstSlide(PresentationDocument presentationDocument) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by GetShapeTreeOfFirstSlide.");
            }
        ...
        public static void AddImage(OpenXmlElement parent, Stream logoStream, int left, int top, int width, int height) {
            if (logoStream == null) {
                throw new ArgumentNullException("logoStream");
            }
            ...
            if (slide == null) {
                throw new ArgumentException("The provided parent element should be in a slide. Did you forget an AddElement()?", "parent");
            }
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by AddImage.");
            }
        }
        ...
        public static Shape CreatePolygon(List<int[]> list, string colorCode = null) {
            if (list.Count <= 0) {
                throw new ArgumentException("list should contain at least one element.", "list");
            }

            foreach (int[] point in list) {
                if (point.Length != 2) {
                    throw new ArgumentException("list should be a list of array of length 2.", "list");
                }
            }
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreatePolygon.");
            }
        ...
        public static D.Paragraph AddParagraph(Shape shape, string text, int fontSize = 800, string fontColorCode = "212121", bool bold = false, D.TextAlignmentTypeValues align = D.TextAlignmentTypeValues.Left) {
            if (fontSize <= 0) {
                throw new ArgumentOutOfRangeException("fontSize", fontSize, "fontSize should be positive.");
            }
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by AddParagraph.");
            }
        ...
        public static void AddTextRun(D.Paragraph paragraph, string text, int fontSize = 800, string fontColorCode = "212121", bool bold = false) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by AddTextRun.");
            }
        }
        ...
        public static GroupShape CreateGroupShape(int left, int top, int width, int height) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreateGroupShape.");
            }
        ...
        public static ConnectionShape CreateConnectionShape(Shape startShape, Shape endShape, int[] startPoint, int[] endPoint) {
            if (startPoint.Length != 2) {
                throw new ArgumentException("startPoint should be an array of length 2.", "startPoint");
            }

            if (endPoint.Length != 2) {
                throw new ArgumentException("endPoint should be an array of length 2.", "endPoint");
            }
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreateConnectionShape.");
            }
        ...
        public static void ResizeGroup(GroupShape groupShape, int width, int height) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by ResizeGroup.");
            }
        }
        ...
        private static void CreatePresentationParts(PresentationPart presentationPart, int slideWidth, int slideHeight) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreatePresentationParts.");
            }
        }
        ...
        private static SlidePart CreateSlidePart(PresentationPart presentationPart) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreateSlidePart.");
            }
        ...
        private static SlideLayoutPart CreateSlideLayoutPart(SlidePart slidePart1) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreateSlideLayoutPart.");
            }
        ...
        private static ThemePart CreateTheme(SlideMasterPart slideMasterPart1) {
            ...
            new D.ColorScheme(
              ...
              new D.LatinFont() { Typeface = "Calibri" },
              new D.EastAsianFont() { Typeface = string.Empty },
              new D.ComplexScriptFont() { Typeface = string.Empty })) { Name = "Office" },
              new D.FormatScheme(
              new D.FillStyleList(
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreateTheme.");
            }
        ...
        private static NonVisualShapeProperties CreateNonVisualShapeProperties(uint id, string typeName) {
            ...
            if (errors.Count() > 0) {
                throw new ApplicationException("Invalid Xml presentation generated by CreateNonVisualShapeProperties.");
            }
        ...
        private static void CheckHexaColorCode(string colorCode) {
            if (colorCode != null && !hexaColorRegex.IsMatch(colorCode)) {
                throw new ArgumentException("The given color code should be a string of 6 hexadecimal digit.");
            }
        }
